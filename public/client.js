// JavaScript source code
      document.getElementById("searchsubmit").addEventListener("click", function(){
          ...
          req.open("GET", "http://flip3.engr.oregonstate.edu:24444/book?title="+title+"&author="+author+"&genre="+genre, true);
		  console.log(req);
          ...
          var req = new XMLHttpRequest();
          req.open("GET", "http://flip3.engr.oregonstate.edu:24444/insertbook?title="+title+"&author="+author+"&genre="+genre, true);
		  console.log(req);	
